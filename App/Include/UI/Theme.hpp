...
namespace UI::Theme
{
	inline constexpr ImVec4 Background    = { 0.010f, 0.012f, 0.011f, 1.f };
	inline constexpr ImVec4 Card          = { 0.016f, 0.020f, 0.017f, 1.f };
	inline constexpr ImVec4 Popover       = { 0.028f, 0.034f, 0.030f, 1.f };
	inline constexpr ImVec4 Elevated      = { 0.040f, 0.050f, 0.043f, 1.f };
	inline constexpr ImVec4 Secondary     = { 0.070f, 0.085f, 0.074f, 1.f };
	inline constexpr ImVec4 Foreground    = { 0.890f, 0.920f, 0.898f, 1.f };
	inline constexpr ImVec4 SecondaryText = { 0.620f, 0.660f, 0.628f, 1.f };
	inline constexpr ImVec4 MutedText     = { 0.430f, 0.475f, 0.443f, 1.f };
	inline constexpr ImVec4 Primary       = { 0.235f, 0.780f, 0.455f, 1.f };
	inline constexpr ImVec4 Success       = { 0.176f, 0.788f, 0.404f, 1.f };
	inline constexpr ImVec4 Warning       = { 0.961f, 0.620f, 0.043f, 1.f };
	inline constexpr ImVec4 Danger        = { 0.937f, 0.267f, 0.267f, 1.f };
	inline constexpr ImVec4 Border        = { 1.f, 1.f, 1.f, 0.06f };
	inline constexpr ImVec4 SurfaceSoft   = { 0.235f, 0.780f, 0.455f, 0.06f };
	inline constexpr ImVec4 SurfaceHover  = { 0.235f, 0.780f, 0.455f, 0.10f };
	...
	inline void apply( )
	{
		...
		c[ ImGuiCol_ScrollbarGrab ]      = { 1.f, 1.f, 1.f, 0.08f };
		c[ ImGuiCol_ScrollbarGrabHovered ] = { 1.f, 1.f, 1.f, 0.15f };
		c[ ImGuiCol_ScrollbarGrabActive ]  = { 1.f, 1.f, 1.f, 0.22f };
		c[ ImGuiCol_CheckMark ]          =
		c[ ImGuiCol_SliderGrab ]         =
		c[ ImGuiCol_SliderGrabActive ]   = Primary;
		c[ ImGuiCol_Button ]             = SurfaceSoft;
		c[ ImGuiCol_ButtonHovered ]      = { 0.235f, 0.780f, 0.455f, 0.16f };
		c[ ImGuiCol_ButtonActive ]       = { 0.235f, 0.780f, 0.455f, 0.28f };
		c[ ImGuiCol_Header ]             = SurfaceSoft;
		c[ ImGuiCol_HeaderHovered ]      = { 0.235f, 0.780f, 0.455f, 0.12f };
		c[ ImGuiCol_HeaderActive ]       = { 0.235f, 0.780f, 0.455f, 0.22f };
	...
	[[nodiscard]] inline constexpr COLORREF background_gdi( ) noexcept
	{
		return RGB( 0x03, 0x03, 0x03 );
	}
	...
	inline void apply_chrome( const HWND hwnd )
	{
		...
		constexpr COLORREF bg  = background_gdi( );
	...
	// Soft orbital reticle — unique to precision-fix (not a grid wash).
	inline void draw_header_ornament( ImDrawList* dl, const ImVec2 min, const ImVec2 max, const ImVec4 accent = Primary )
	{
		...
		// Layered bloom (no hard circle edge)
		for ( int i = 5; i >= 1; --i )
		{
		...
		// Concentric arc segments that drift slowly
		for ( int ring = 0; ring < 3; ++ring )
		{
			...
			// Secondary gap arc on the opposite side
			dl->PathClear( );
